						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-4">Clínica Jurídica del Alumno</label>
                                    ...
                                    <!-- form del boton -->
                                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#boton">Registrar Alumno</button>
										...
										<div class="modal-dialog">
										  ...
										  <div class="modal-content">
											<div class="modal-header">
											  <h1 type="button" class="close" data-dismiss="modal">Se ha registrado correctamente al Alumno</h1>
											</div>									
