...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Intranet | Log Usuarios</title>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({			
					...
					datatype: "local",
					height: 'auto',
					colNames:['Id','Fecha', 'Descripcion'],
					colModel:[
                        
						{name:'id',index:'id', width:50, sortable:true, editable: true, resize:true,edittype:'select', editoptions:{value:{1:'Persona',2:'Institucion'}}},
