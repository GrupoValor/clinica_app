						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-4">Nivel educativo</label>
									...
									<div class="form-group">
										...
										<label class="col-sm-3 control-label no-padding-right" for="form-field-4">N&uacute;mero de hijos</label>
										<div class="col-sm-9">
											<input type="text" id="spinner3" />
											<div class="space-6"></div>
										</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-4">Direccion</label>

										<div class="col-sm-9">
											<input class="input-sm" type="text" id="form-field-4" placeholder="Direccion" />
											<div class="space-2"></div>
										</div>
									</div>
									
									<div class="control-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-3">Población Vulnerable</label>
									...
									<div align="center">		
									   <!-- form del boton -->
                                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#boton">Registrar Cliente</button>
										...
										<div class="modal-dialog">
										  ...
										  <div class="modal-content">
											<div class="modal-header">
											  <h1 type="button" class="close" data-dismiss="modal">Se ha registrado correctamente al Cliente</h1>
											</div>									
...
<![endif]-->
		...
		<script type="text/javascript">
            ...
            jQuery('#mant-cli-reg').addClass('active');
			jQuery(function($) {
				//datepicker plugin
				//link
