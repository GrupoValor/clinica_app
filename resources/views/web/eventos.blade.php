                    ...
                    success: function(result){
                        ...
                        for(var i = 0; i<data.length ;i++)
                        {
							...
							if(data[i].visible == 1){
								...
								var codigo = '<div class="documentos-modu" id="D"><h2 class="h2-direc"><a href="plantillaEvento.html">'+titulo+'</a></h2><div class="direc-img" data="acf-img"><img src="'+imagen+'"></div><div class="direc-text"><div class="direc-info"><strong>Inicio:</strong>'+' Del '+inicio+' al '+fin+'</div>	<div class="link-btn btn-diplo"><a href="https://docs.google.com/forms/d/e/1FAIpQLSfZKJaZnzker7WHwbJeNJoJDfK4SActHxkgjKxhkMfVcZDYUQ/viewform" target="_blank">Inscribirme<div class="link-btn-icon"></div></a></div></div><div class="clear cero"></div></div>';
