...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Intranet | Directorio | Registro</title>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input id="dir_telefono" type="text" id="form-field-4" class="col-xs-10 col-sm-5" />
										</div>
									</div>
                                    <div class="space-4"></div>
                                    <div class="form-group">
                                ...
                                <label class="col-sm-3 control-label no-padding-right"
                                       for="form-field-4">Dirección</label>

                                <div class="col-sm-4">
                                    <!--<input class="input-sm" type="text" id="form-field-4" placeholder="Observaciones" />
                                    <div class="space-2"></div>-->
                                    <textarea id="dir_direccion" class="form-control" rows="4"></textarea>
                                </div>
                            </div>				
